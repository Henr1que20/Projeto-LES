...
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Alex da Silva', NOW(), 'alex@gmail.com', '1993-05-01', '93028902010', 'M', 1);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Bruno da Silva', NOW(), 'bruno@gmail.com', '2000-03-13', '61483280039', 'M', 2);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Caio da Silva', NOW(), 'caio@gmail.com', '1988-04-16', '89383951036', 'M', 3);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Daniela de Oliveira', NOW(), 'daniela@gmail.com', '1990-09-10', '38619906011', 'F', 4);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Evandro dos Santos', NOW(), 'evandro@gmail.com','2001-01-05', '83432488050', 'M', 5);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Fabio Assunção', NOW(), 'fabio@gmail.com', '1999-02-02', '00877208093', 'M', 6);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Gabriela de Andrade', NOW(), 'gabriela@gmail.com', '1995-11-25', '85733542080', 'F', 7);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Henrique de Oliveira', NOW(), 'henrique@gmail.com', '2001-11-09', '37964642030', 'M', 8);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Isabel Nogueira', NOW(), 'isabel@gmail.com', '1985-12-25', '49618633004', 'F', 9);
INSERT INTO tb_cliente (nome, dat_criacao, email, data_nascimento, cpf, genero, usuario_id) VALUES ('Julio de Amorim', NOW(), 'julio@gmail.com', '1995-02-17', '15413355033', 'M', 10);
